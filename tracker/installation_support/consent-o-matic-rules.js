/** 
 * This file contains copied rules from consent-o-matic package, with the $schema key deleted:
 * @see tracker/node_modules/consent-o-matic/Extension/contentScript.js L29
 * 
 * The rules are copied rather than imported because rollup doesn't support json imports without a plugin.
 * Ideally we'd use something like `import cookiebot from 'tracker/node_modules/consent-o-matic/rules/cookiebot.json' with {type: 'json'}`
 */
                ...
                "showingMatcher": [
                    {
                        "type": "css",
                        "target": {
                            "selector": "#CybotCookiebotDialogBodyButtonAccept, #CybotCookiebotDialogBody, #CybotCookiebotDialogBodyLevelButtonPreferences, #cb-cookieoverlay, #CybotCookiebotDialog, #cookiebanner",
                            "displayFilter": true
                        }
                    }
                ]
                            ...
                            "consents": [
                                {
                                    "matcher": {
                                        "type": "checkbox",
                                        "target": {
                                            "selector": "#CybotCookiebotDialogBodyLevelButtonPreferences, [name='preferences']"
                                        }
                                    },
                                    "toggleAction": {
                                        "type": "click",
                                ...
                                },
                                {
                                    "matcher": {
                                        "type": "checkbox",
                                        "target": {
                                            "selector": "#CybotCookiebotDialogBodyLevelButtonStatistics,[name='statistics']"
                                        }
                                    },
                                    "toggleAction": {
                                        "type": "click",
                                ...
                                },
                                {
                                    "matcher": {
                                        "type": "checkbox",
                                        "target": {
                                            "selector": "#CybotCookiebotDialogBodyLevelButtonMarketing,[name='marketing']"
                                        }
                                    },
                                    "toggleAction": {
                                        "type": "click",
                ...
                "action": {
                    ...
                    "actions": [
                        ...
                        },
                        {
                            "type": "click",
                            "target": {
                                "selector": "[onclick='handleCustomConsent();']",
                                "displayFilter": true
                            }
                        },
                        {
